<%@ Page Title="Quản lý tệp tin" Language="C#" AutoEventWireup="true" CodeBehind="dialog.aspx.cs"
    Inherits="TinyFileManager.NET.dialog" %>
...
<head>
    ...
    <title> Quản lý tệp tin hệ thống</title>
...
<body>
    ...
    <!----- uploader div start ------->
    <div class="uploader">
        <form action="dialog.aspx?cmd=upload" method="post" enctype="multipart/form-data"
        ...
        <center>
            <button class="btn btn-large btn-primary close-uploader"><i class="icon-backward icon-white">
            </i> Quay trở lại danh sách tệp tin</button></center>
    ...
    <div class="container-fluid">
        ...
        <div class="filters">
            <% if (this.objConfig.boolAllowUploadFile)
               { %>
            <button class="btn btn-primary upload-btn" style="margin-left: 5px;"><i class="icon-upload icon-white">
            </i> Tải file lên</button>
            <% } %>
            <% if (this.objConfig.boolAllowCreateFolder)
               { %>
            <button class="btn new-folder" style="margin-left: 5px;"><i class="icon-folder-open">
            </i>Tạo thư mục</button>
            <% } %>
            ...
            <div class="pull-right">
                ...
                <input id="select-type-all" name="radio-sort" type="radio" data-item="ff-item-type-all"
                    class="hide" />
                <label id="ff-item-type-all" for="select-type-all" class="btn btn-info ff-label-type-all">
                    Tất cả</label>
                &nbsp;
                ...
                <input id="select-type-2" name="radio-sort" type="radio" data-item="ff-item-type-2"
                    class="hide" />
                <label id="ff-item-type-2" for="select-type-2" class="btn ff-label-type-2">Ảnh</label>
                <input id="select-type-4" name="radio-sort" type="radio" data-item="ff-item-type-4"
                    class="hide" />
                <label id="ff-item-type-4" for="select-type-4" class="btn ff-label-type-4">Tệp video</label>
                &nbsp;
                   
                <input id="select-type-5" name="radio-sort" type="radio" data-item="ff-item-type-5"
                    class="hide" />
                <label id="ff-item-type-5" for="select-type-5" class="btn ff-label-type-5">Tệp âm thanh</label>
                &nbsp;
                   
    <input id="select-type-3" name="radio-sort" type="radio" data-item="ff-item-type-3"
        class="hide" />
                <label id="ff-item-type-3" for="select-type-3" class="btn ff-label-type-3">Tệp khác</label>
                &nbsp;
    ...
    <!----- lightbox div end ------->
    <div id="previewLightbox" class="lightbox hide fade" tabindex="-1" role="dialog"
        aria-hidden="true">
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            Dropzone.options.myAwesomeDropzone = {
                ...
                maxFilesize:<% Response.Write(this.objConfig.intMaxUploadSizeMb); %>,
