<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdUcHocVi.ascx.cs" Inherits="QuanLyCongBoKhoaHoc.Admin.AdUserControl.AdUcHocVi" %>
<div class="">
    <h3>Quản lý Học Vị</h3>
    <div class="table-responsive">
        <asp:GridView ID="gvHocVi" runat="server" AllowPaging="True" PageSize="15" CssClass="table table-bordered table-hover"
            AutoGenerateColumns="False"    HeaderStyle-HorizontalAlign="Center"  HeaderStyle-VerticalAlign="Middle"
            DataKeyNames="MaHocVi" ShowHeaderWhenEmpty="True" OnRowCommand="gvHocVi_RowCommand" OnRowDeleting="gvHocVi_RowDeleting" >
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                ...
                <asp:BoundField DataField="MaHocVi" HeaderText="Mã học vị" ItemStyle-CssClass="col-lg-1" SortExpression="MaHocVi" />
                <asp:BoundField DataField="TenHocVi" SortExpression="TenhocVi" HeaderText="Tên học vị" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 id="myModalLabel">Thêm sửa học vị</h4>
            </div>

            <div class="modal-body">
                <div class="form-group">
                    <label class="col-sm-4 col-lg-3 control-label">Tên học vị :</label>
                    <div class="col-sm-8 col-lg-9 controls">
                        <asp:TextBox ID="txtTenHocVi" runat="server" class="form-control" data-rule-required="true" Height="23px"></asp:TextBox>
                    </div>
                </div>            
            </div>
